...
public class FXMLAnchorPaneGraficosVendasPorMesController implements Initializable {
	 ...
	 @FXML
	    ...
	    public void initialize(URL url, ResourceBundle rb) {
	        ...
	        // Aqui a gente obtei um array com os nomes dos meses em inglês para fazer a conversão lá na frente
	        ...
	        // vai ser feito uma série para cada dano dentro do arraylist
